    ...
    public void contextDestroyed(ServletContextEvent sce)
    {
        try
        {
            ...
            if (LOG.isDebugEnabled())
                LOG.debug("jakarta.el.BeanELResolver purged");
        }
        ...
        {
            LOG.warn("Cannot purge classes from jakarta.el.BeanELResolver", e);
        }
        catch (NoSuchFieldException e)
        {
            LOG.debug("Not cleaning cached beans: no such field jakarta.el.BeanELResolver.properties");
        }
    }
